...
public class StepImplementations {
	...
	BROWSERS browser_type = BROWSERS.CHROME; // Change this to change what browser is used.
	...
	public void startUp() {
		...
		// For Chrome. Following is added to fix chrome maximize issue.
		...
		else if (browser_type == BROWSERS.FIREFOX) {
	...
	// =============================================================================
	// Following are steps. Try to put the steps in order like in the feature files.
	// =============================================================================
	@Given("^I want to login to the portal \"(.*?)\"$")
	...
	public void i_click_on_text(String arg1) throws Throwable {
		if (arg1.equals("Users")) {
			...
			String txtToBeClicked = PageFactory.initElements(driver, DBUtilities.class).xpathMakerContainsText2ndOption(arg1);
			WebElement exist = driver.findElement(By.xpath(txtToBeClicked));
	...
	public void i_select_option_from(String arg1, String arg2) throws Throwable {
		...
		else if (arg1.equals("AgeRange") || arg1.equals("Agent Administrator") || arg1.equals("ADS") || arg1.equals("RBU Officer") || arg1.equals("Housing Officer") || arg1.equals("Agency Admin")) {
	...
	@Then("^I select option \"(.*?)\" from \"(.*?)\" in \"(.*?)\" row$")
	public void i_select_option_from_in_row(String arg1, String arg2, String arg3) throws Throwable {
		if (arg1.isEmpty()) {
			Log.info("Element is not expected to appear on screen");
		}
		else {
			...
			driver.findElement(By.xpath("//span[text()='" + arg3 + "']/parent::div/parent::td/following-sibling::td//*[contains(@name,'" + arg2 + "')]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("//span[text()='" + arg3 + "']/parent::div/parent::td/following-sibling::td//option[contains(text(),'" + arg1 + "')]")).click();
		}
	}
	...
	@Then("^I click on \"(.*?)\" button of \"(.*?)\" row$")
	public void i_click_on_button_of_row(String arg1, String arg2) throws Throwable {
		driver.findElement(By.xpath("//div[contains(text(),'" + arg2 + "')]//following-sibling::div//a[contains(@id,'" + arg1 + "')]")).click();
	}
	...
	@And("I see text \"(.*?)\" in \"(.*?)\" input box displayed$")
	public void i_see_text_in_input_box_displayed(String arg1, String arg2) throws Throwable {
		Assert.assertTrue(driver.findElement(By.xpath("//*[contains(@id, '" + arg2 + "') and contains(@value, '" + arg1 + "')]")).isDisplayed());
	}
	
	@Then("^I click on \"(.*?)\" button with type \"(.*?)\"$")
	public void i_click_on_button_with_type(String arg1, String arg2) throws Throwable {
		driver.findElement(By.xpath("//*[contains(text(), '" + arg1 + "') and contains(@type,'" + arg2 + "')]")).click();
	}
	
	@Then("I click on \"(.*?)\" button with class \"(.*?)\"$")
	public void i_click_on_button_with_class(String arg1, String arg2) throws Throwable {
		driver.findElement(By.xpath("//*[contains(text(),'" + arg1 + "')]//preceding-sibling::span//*[contains(@class, '" + arg2 + "')]")).click();
	}
...
//			Assert.assertTrue(object.isDisplayed());
	...
	public void i_select_from(String arg1, String arg2) throws Throwable {
		...
		if (arg1.isEmpty()) {
			Log.info("Element is not expected to appear on screen");
		} else if (arg1.equals("Virtual") || arg1.equals("Agent Administrator")
				|| arg1.equals("RBU Team Leader") || arg1.equals("RBU Officer") || arg1.equals("Virtual")
				|| arg1.equals("Agency Admin")|| arg1.equals("Globex Corporation")) {
			String myxpath = PageFactory.initElements(driver, DBUtilities.class).xpathMakerContainsText1stOption(arg1);
			String myxpath2 = PageFactory.initElements(driver, DBUtilities.class).xpathMakerById(arg2);
			System.out.println(" looking for dropdown xpath " + myxpath);
			driver.findElement(By.xpath(myxpath2)).click();
	...
	// following is for icons in table

	
//	@Then("^I \"(.*?)\" on  table \"(.*?)\" with row containing \"(.*?)\" and \"(.*?)\" element icon$")
//	public void i_on_table_with_row_containing_and_element_icon(String arg1, String arg2, String arg3, String arg4) throws Throwable {
//	
//		
//		try {
//			String tableXpath = PageFactory.initElements(driver, DBUtilities.class).xpathMakerPickTrTextInTableID(arg3,
//					arg2);
//			//to pick up exact value from scenario
//			
//			String rowelement = tableXpath+"[1]";
//			System.out.println(rowelement);
//			WebElement element = driver.findElement(By.xpath(rowelement));
...
//	}
	...
	public void i_table_exist_and_row_containing_image(String arg1, String arg2, int arg3, String arg4) throws Throwable {

		try {
			String tableXpath = PageFactory.initElements(driver, DBUtilities.class).xpathMakerPickRowNoWithImage(arg2,arg3,arg4);
	...
	public void i_check_that_table_with_row_containing_returns_atleast_row(String arg1, String arg2, String arg3) throws Throwable {

		String tableRow = PageFactory.initElements(driver, DBUtilities.class).xpathMakerCountRowsOfTable(arg1,
				arg3);
	...
	public void i_row_of_table(String arg1, String arg2, String arg3) throws Throwable {
		if(arg1.equals("click")){
			...
			//String tableRow = PageFactory.initElements(driver, DBUtilities.class).xpathMakerPickFirstRowInTable(arg2,arg3);
